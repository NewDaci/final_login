        ...
        await fetch('http://localhost:3000/api/auth/signup', options)
            ...
            .then((data) => {
                if (data && data.user) {
                    ...
                    setAlert({ type: 'error', message: data.message || 'An error occurred while registering.' });
                }
            })
    }
            ...
            <section className='w-3/4 mx-auto flex flex-col gap-10'>
                ...
                <form className='flex flex-col gap-5' onSubmit={formik.handleSubmit}>
                    ...
                    <div className='w-3/4 mx-auto flex flex-col gap-10'>
                        {alert.message !== '' && (
                            <p className={`alert-${alert.type} w-3/4 mx-auto p-4 rounded-lg text-red font-bold`}>
                                {alert.message}
                            </p>
                        )}
                    </div>
